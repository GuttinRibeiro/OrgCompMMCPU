/* code-c - Student's code for mmcpu
   ...
   Copyright 2017  [Augusto Ribeiro Castro]   [augusto.ribeiro.castro@usp.br]
...
//Mudei os includes porque o script não funcionou no meu PC, preferi compilar manualmente.
/*#include <mmcpu/cpu.h>
...
/* Existem vários prints para depuração do código comentados. Caso necessite ativá-los, seja feliz.*/

// Includes para compilação manual:
#include "mask.h"
#include "cpu.h"
